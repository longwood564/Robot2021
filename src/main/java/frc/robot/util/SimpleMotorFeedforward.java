...
// This class is taken from this (https://github.com/wpilibsuite/allwpilib/pull/3183) PR, which adds
// a convenience overload of calculate() that takes the previous and current velocities, rather than
